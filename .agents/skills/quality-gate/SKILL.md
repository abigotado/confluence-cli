---
name: quality-gate
description: Run the confluence-cli validation gate — formatting, vet, race tests, and the agent-harness checks — and report exactly what passed and what was not run. Use before pushing, before opening a PR, or when asked whether the repository is green.
---

# Run confluence-cli Quality Gate
