---
name: review
description: Review completed confluence-cli changes for correctness, architecture, regressions, contract breakage, leaked credentials, and missing tests. Use before merging, or when asked to check work that is already written.
---

# Review confluence-cli Change
