---
name: plan
description: Produce an evidence-based, dependency-ordered plan for a confluence-cli change without editing any files. Use before implementing anything that spans multiple packages, touches the machine contract, or has more than one reasonable approach.
---

# Plan confluence-cli Change
