...
RULES = {
    "architecture": {
        "description": "confluence-cli package boundaries and dependency direction.",
        "always_apply": True,
        "globs": None,
    },
    ...
    "cli-contract": {
        "description": "confluence-cli JSON envelope, exit codes, and flag naming contract.",
        "always_apply": False,
        "globs": "internal/cli/**/*.go,internal/errx/**/*.go,internal/output/**/*.go",
    },
    "go-style": {
        "description": "confluence-cli Go conventions: errors, context, resources, naming.",
        "always_apply": False,
        "globs": "**/*.go",
    },
    "testing": {
        "description": "confluence-cli table-driven tests and boundary mocking conventions.",
        "always_apply": False,
        "globs": "**/*_test.go",
    },
    ...
    "secrets": {
        "description": "confluence-cli credential storage, redaction, and logging rules.",
        "always_apply": True,
        "globs": None,
    },
    ...
    "quality-gates": {
        "description": "confluence-cli Git hook installation and the pre-push quality gate.",
        "always_apply": True,
        "globs": None,
    },
}
